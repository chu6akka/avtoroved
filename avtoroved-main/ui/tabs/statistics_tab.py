...
class StatisticsTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        idx_hdr = QLabel(
            ...
            "Источник: Лаб. работа № 11, судебная автороведческая экспертиза / Соколова Т.П. (МГЮА).\n"
            "Местоимения (инд. 2, 5, 10) = PRON + DET (традиционная русская грамматика).\n"
            "Инд. 14 — чистые наречия без СКС; инд. 16 — знаменатель включает СКС.\n"
            "Инд. 19 — падежные формы только сущ. и мест. Инд. #7 недоступен автоматически."
        )
