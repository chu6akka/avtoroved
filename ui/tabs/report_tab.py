...
try:
    from lexical_stratification import LAYER_ORDER, LAYER_LABELS, _make_conclusion
...
class ReportTab(QWidget):
    ...
    def generate_report(self, text: str, metrics: dict, error_result,
        ...
        if _STRAT_AVAILABLE and strat_result:
            ...
            try:
                ...
                for l in _make_conclusion(strat_result).split("\n"):
                    lines.append(f"  {l}")
            except Exception:
                pass
