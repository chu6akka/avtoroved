...
class QwenShadowService:
    ...
    def _prompts(self, profile: QwenShadowProfile, text: str) -> tuple[str, str]:
        ...
        system = (
            ...
            "цитатой из текста. Если надёжной цитаты нет, верни ровно status "
            "INSUFFICIENT_DATA и пустой observations; никогда не помещай слово "
            "INSUFFICIENT_DATA в quote. /no_think"
        )
        user = json.dumps({
            "profile": {
